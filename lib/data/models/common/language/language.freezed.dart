...
mixin _$Language {
 ...
 int get id; String get locale; String? get name; String? get direction; String? get flag; bool get isDefault; bool get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,locale,name,direction,flag,isDefault,status);

@override
String toString() {
  return 'Language(id: $id, locale: $locale, name: $name, direction: $direction, flag: $flag, isDefault: $isDefault, status: $status)';
}
...
@useResult
$Res call({
 int id, String locale, String? name, String? direction, String? flag, bool isDefault, bool status
});
...
/// Create a copy of Language
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? locale = null,Object? name = freezed,Object? direction = freezed,Object? flag = freezed,Object? isDefault = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String locale,  String? name,  String? direction,  String? flag,  bool isDefault,  bool status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Language() when $default != null:
return $default(_that.id,_that.locale,_that.name,_that.direction,_that.flag,_that.isDefault,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String locale,  String? name,  String? direction,  String? flag,  bool isDefault,  bool status)  $default,) {final _that = this;
switch (_that) {
case _Language():
return $default(_that.id,_that.locale,_that.name,_that.direction,_that.flag,_that.isDefault,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String locale,  String? name,  String? direction,  String? flag,  bool isDefault,  bool status)?  $default,) {final _that = this;
switch (_that) {
case _Language() when $default != null:
return $default(_that.id,_that.locale,_that.name,_that.direction,_that.flag,_that.isDefault,_that.status);case _:
  return null;
...
class _Language implements Language {
  const _Language({required this.id, required this.locale, this.name, this.direction, this.flag, this.isDefault = false, this.status = true});
...
/// Create a copy of Language
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? locale = null,Object? name = freezed,Object? direction = freezed,Object? flag = freezed,Object? isDefault = null,Object? status = null,}) {
