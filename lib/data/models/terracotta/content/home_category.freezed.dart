...
/// points at, and the key to join against the full category list.
 int get id;/// Display name, already localized by the CMS ("Cups", "Vases").
 String get title;/// Category artwork.
 ApiImage? get image;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeCategory&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.image, image) || other.image == image));
}
...
@override
String toString() {
  return 'HomeCategory(id: $id, title: $title, image: $image)';
}
...
/// Create a copy of HomeCategory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? image = freezed,}) {
...
class _HomeCategory implements HomeCategory {
  const _HomeCategory({required this.id, required this.title, this.image});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeCategory&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.image, image) || other.image == image));
}
...
/// Create a copy of HomeCategory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? image = freezed,}) {
