...
mixin _$Complaint {
 ...
 int get id;/// What it is about (`"delivery"`). Read via [kind].
 String get type;/// The customer's own words. Never localized, never a key.
 String get message;/// Studio ticket number, as a String. Null until assigned.
 String? get reference;/// CMS-editable workflow state (`"new"`). Read via [statusKind],
/// but prefer [isResolved].
 String get status; DateTime get createdAt;/// When the studio closed it. Null while open.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,message,reference,status,createdAt,resolvedAt);

@override
String toString() {
  return 'Complaint(id: $id, type: $type, message: $message, reference: $reference, status: $status, createdAt: $createdAt, resolvedAt: $resolvedAt)';
}
...
@useResult
$Res call({
 int id, String type, String message, String? reference, String status, DateTime createdAt, DateTime? resolvedAt
});
...
/// Create a copy of Complaint
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? message = null,Object? reference = freezed,Object? status = null,Object? createdAt = null,Object? resolvedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String type,  String message,  String? reference,  String status,  DateTime createdAt,  DateTime? resolvedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Complaint() when $default != null:
return $default(_that.id,_that.type,_that.message,_that.reference,_that.status,_that.createdAt,_that.resolvedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String type,  String message,  String? reference,  String status,  DateTime createdAt,  DateTime? resolvedAt)  $default,) {final _that = this;
switch (_that) {
case _Complaint():
return $default(_that.id,_that.type,_that.message,_that.reference,_that.status,_that.createdAt,_that.resolvedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String type,  String message,  String? reference,  String status,  DateTime createdAt,  DateTime? resolvedAt)?  $default,) {final _that = this;
switch (_that) {
case _Complaint() when $default != null:
return $default(_that.id,_that.type,_that.message,_that.reference,_that.status,_that.createdAt,_that.resolvedAt);case _:
  return null;
...
class _Complaint extends Complaint {
  const _Complaint({required this.id, required this.type, required this.message, this.reference, required this.status, required this.createdAt, this.resolvedAt}): super._();
...
/// Create a copy of Complaint
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = null,Object? message = null,Object? reference = freezed,Object? status = null,Object? createdAt = null,Object? resolvedAt = freezed,}) {
