...
/// The lines, newest last. Empty for a fresh customer.
 List<CartItem> get items;/// Sum of the lines' `line_total` as a decimal string
...
@useResult
$Res call({
 List<CartItem> items, String totalPrice
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CartItem> items,  String totalPrice)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Cart() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CartItem> items,  String totalPrice)  $default,) {final _that = this;
switch (_that) {
case _Cart():
return $default(_that.items,_that.totalPrice);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<CartItem> items,  String totalPrice)?  $default,) {final _that = this;
switch (_that) {
case _Cart() when $default != null:
return $default(_that.items,_that.totalPrice);case _:
  return null;
...
class _Cart extends Cart {
  const _Cart({final  List<CartItem> items = const <CartItem>[], required this.totalPrice}): _items = items,super._();
