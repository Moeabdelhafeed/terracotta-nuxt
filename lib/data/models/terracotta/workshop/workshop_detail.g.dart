...
_WorkshopDetail _$WorkshopDetailFromJson(
  ...
  categories:
      (json['categories'] as List<dynamic>?)
          ?.map((e) => WorkshopCategory.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const <WorkshopCategory>[],
  ownPieces: json['own_pieces'] == null
      ? null
      : WorkshopOwnPieces.fromJson(json['own_pieces'] as Map<String, dynamic>),
);

Map<String, dynamic> _$WorkshopDetailToJson(_WorkshopDetail instance) =>
    <String, dynamic>{
      'id': instance.id,
