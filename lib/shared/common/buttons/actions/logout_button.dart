...
/// Destructive log-out — shares its copy with the logout confirm sheet/dialog.
///
/// Label, icon, semantics and destructive styling are baked in and localized;
...
class LogoutButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CommonActionButton(
      label: SheetStrings.logoutConfirm,
